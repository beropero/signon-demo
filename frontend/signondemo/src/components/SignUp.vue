<template>
  ...
  <el-form-item label="密码">
      <el-input type="password1" v-model="form.pass1" clearable placeholder="请输入密码" maxlength="30" show-password/>
    </el-form-item>
    <el-form-item label="确认密码">
      <el-input type="password2" v-model="form.pass2" clearable placeholder="请再次输入密码" maxlength="30" show-password/>
    </el-form-item>
  ...
  <el-form-item>
      ...
      <el-col :span="8">
          <el-link href="/signin">have account?</el-link>
      </el-col>
  </el-form-item>
  </el-form>
</template>
...
<script lang="ts" setup>
  ...
  import { emailSignUp } from '@/api/email';
  import { mobileSendCode } from '@/api/mobile';
  import { mobileSignUp } from '@/api/mobile';
